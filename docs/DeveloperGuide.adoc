...
This feature presents the planner in different formats to the user. This section will detail how this feature is implemented.
{zwsp}
...
Upon entering the `view` command with valid parameters (refer to <<UserGuide#view, UserGuide.adoc>> for `view` usage),
