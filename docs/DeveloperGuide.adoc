...
* MSS:
. User inputs the command to view all slots along with the specific day or date in the current semester.
. System displays all the slots for that specified day or date.
+
Use case ends.
* Extensions:
